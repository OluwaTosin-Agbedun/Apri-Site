/**
 * The briefing names, which the request form also offers. Declared here
 * because the Vite-era AppContext that used to own this union is gone.
 */
export type BriefingType = "Board Political & Regulatory Risk Briefing" | "Executive Political & Regulatory Briefing" | "Strategy & Retreat Briefing" | "Sector Political & Regulatory Risk Briefing" | "Rapid Intelligence Briefing" | "Diplomatic & Institutional Briefing"

export const BRIEFING_TYPES: readonly (BriefingType | "Not sure / request guidance")[] =
  [
    ...
    "Diplomatic & Institutional Briefing",
...
/** The six services, in the page order specified by the brief. */
export const SERVICES: ServiceItem[] = [
  {
    ...
    body: "This briefing provides a board-level assessment of Nigeria’s political, regulatory and political economy outlook, with emphasis on enterprise risk, capital allocation, regulatory exposure, electoral and political-transition scenarios, institutional behaviour and sector-specific vulnerabilities.",
  ...
  },
  {
    ...
    body: "This briefing translates political and regulatory developments into management-level implications for operating plans, stakeholder strategy, compliance exposure, market positioning and 30–180 day decision-making.",
    listLabel: "Typical use cases",
    listItems: [
  ...
  },
  {
    ...
    body: "This session provides a structured view of the external political, regulatory and political economy environment, helping leadership teams understand the risks, pressures and policy signals likely to affect business planning.",
    listLabel: "Typical themes",
    listItems: [
      "Nigeria’s political and regulatory outlook",
      "Electoral transition and business risk",
  ...
  },
  {
    ...
    body: "This briefing helps organisations understand what changed, why it matters, what is still uncertain and what should be watched next.",
  ...
  },
  {
    ...
    title: "Diplomatic & Institutional Briefing",
    kind: "Diplomatic and institutional intelligence session",
    designedFor:
      "Designed for diplomatic missions, international organisations, development institutions and other non-commercial institutions requiring an independent Nigerian assessment of political, regulatory, electoral and policy developments.",
    listLabel: "Typical use cases",
    listItems: [
      "Head of Mission or senior leadership briefing",
      "Political and economic section briefing",
      "Nigeria country assessment",
      "Political and regulatory outlook",
      "Electoral and democratic environment assessment",
      "Issue-specific or sectoral intelligence session",
    ],
    format: "Private briefing and Q&A",
    delivery: "Virtual or in person",
    ctaLabel: "Request a Diplomatic & Institutional Briefing",
