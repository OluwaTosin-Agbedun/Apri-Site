...
export default function BriefingForm({
  ...
  const defaultType =
    initialType && BRIEFING_TYPES.some((type) => type === initialType)
      ? initialType
      : ""
  ...
  return (
    <form
      action={action}
      className="border border-border bg-card/30 p-8 sm:p-10 max-w-2xl space-y-6"
    >
      ...
      <div>
        <label htmlFor="briefingType" className={label}>
